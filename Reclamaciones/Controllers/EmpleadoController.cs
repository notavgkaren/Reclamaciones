...
namespace Reclamaciones.Controllers
{
    public class EmpleadoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Cedula,DepartamentoId,HorasTrabajo,Salario,Bono,FechaInico")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Cedula,DepartamentoId,HorasTrabajo,Salario,Bono,FechaInico")] Empleado empleado)
        {
            if (ModelState.IsValid)
            {
